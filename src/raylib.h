...
RLAPI void DrawPolyPro(Vector2 center, Vector2 *points, int pointCount, Color color);                    // Draw a filled custom polygon with variable number of points (Vector version)
RLAPI void DrawPolyLines(Vector2 center, int sides, float radius, float rotation, Color color);          // Draw a polygon outline of n sides
RLAPI void DrawPolyLinesEx(Vector2 center, int sides, float radius, float rotation, float lineThick, Color color); // Draw a polygon outline of n sides with extended parameters
RLAPI void DrawPolyLinesPro(Vector2 *points, int pointCount, Color color);                               // Draw a custom polygon outline with variable number of points
